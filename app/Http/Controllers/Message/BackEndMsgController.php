    ...
    public function showMessage()
    {
        try {
            $data = FeedBack::join('users as userFrom','from_uesr_id','userFrom.id')
                ...
                ->select('feed_backs.id','content->title as title', 'userFrom.name as nameFrom', 'userTo.name as nameTo', 'content->type as type', 'feed_backs.updated_at', 'feed_backs.created_at')
